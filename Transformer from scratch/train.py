...
def get_ds(config):
    ...
    print(f'Max length of the source sentence is: {max_len_src}')    
    print(f'Max length of the target sentence is: {max_len_tgt}')
...
def train_model(config):
    ...
    for epoch in range(initial_epoch, config['num_epochs']):
        ...
        torch.save({
            ...
            'optimizer_stete_dict': optimizer.state_dict(),
